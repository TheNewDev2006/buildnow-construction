...
<head>
    ...
    $siteTitle = 'Buildnow Construction';
    $siteDescription = 'Buildnow delivers residential and commercial construction, renovation, and project management services.';

    if ($currentPage === 'index-7.php') {
